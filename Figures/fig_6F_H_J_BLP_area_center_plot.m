...
%% 2. Per-type grouped-bar metrics (created figures 1 / 2 / 3)
% figure 1 = RF/PF area bar (no paper panel), figure 2 = panel 6F, figure 3 = panel 6H.
...
configs = {
    ...
    struct('name','Center diff (In - Out)', ...
           ...
           'savename','fig_6F_BLP_center_diff'), ...
    ...
    struct('name','Center diff flip (In - Out)', ...
           ...
           'ylabel','Degrees', 'ylim',[], 'sort_by','first', ...
           'savename','fig_6H_BLP_center_diff_flip')
};
...
%% 3. Figure 4 (panel 6J): RF area vs PF area scatter (mean per type)
