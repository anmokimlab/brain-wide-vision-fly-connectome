%% ============================================
%  BLP neurons: weighted (theta, phi) projective/receptive fields
...
% BLP neuron classification (provides BLP_R_NPIs, BLP_R_by_type), from
...
for nt = 2:length(neuron_types)
    ...
    % --- Filter and store synapse coordinates ---
    for i = 1:height(current_neurons)
        rid = current_neurons.root_id(i);
