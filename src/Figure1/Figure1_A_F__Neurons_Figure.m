...
%% change the file names according to the neurons you want to plot
close all 
clearvars -except FAFB_synapse_coordinates
clc

NeuronFaces = readmatrix('C:\Users\user\Documents\MATLAB\FAFB_v2\V738_V5_20250730\Figure1_Overall\720575940635224943_LC9_faces.csv');
NeuronVertices=readmatrix('C:\Users\user\Documents\MATLAB\FAFB_v2\V738_V5_20250730\Figure1_Overall\720575940635224943_LC9_vertices.csv');
...
Ref_y_mean=mean([Input_location(:,1);Output_location(:,2)]);
Ref_z_mean=mean([Input_location(:,1);Output_location(:,3)]);
